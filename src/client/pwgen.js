/* From https://github.com/j-c-m/xkcd-password-generator under MIT license, modified */

import $ from 'jquery';

var wordlist_url = '../../res/en_wordlist.txt';
var wordlist = undefined;

export async function pw_gen(callback, numwords, digits, caps) {
    ...
    const res = await $.get(wordlist_url);
    wordlist = res.split('\n');
    ...
    if (typeof (callback) === 'function') {
        callback(words, Math.floor(entropy));
    }
